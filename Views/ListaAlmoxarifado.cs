namespace Views
{
    class ListaAlmoxarifado : Form
    {
        ...
        {
            this.Name = "LISTA DE ALMOXARIFADO";
            this.Text = "Lista de almoxarifados";
        ...
        public void Criar_Click(object sender, EventArgs e)
        {
            ...
            Almoxarifado f7 = new Almoxarifado(controller, this);
            f7.FormLayout();
            f7.Show();
        }
        private void Alterar_Click(object sender, EventArgs e)
        {
            if (GridView.SelectedRows.Count != 0)
            {
                ...
                Almoxarifado f8 = new Almoxarifado(controller, this);
                f8.FormLayout();
                f8.Alterar(Int32.Parse(id));
                f8.Show();
            }
            else
            {
                MessageBox.Show("Selecione um almoxarifado!");
            }
